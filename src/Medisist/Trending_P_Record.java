 ...
 * @author dev
 */
public class Trending_P_Record extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;
    ...
    private void Get_Data(){
        String sql="select Trednig_ID as 'Trednig_ID', Disease_Name as 'Disease Name', Remark from trending";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Trending_P_Record.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Trending_P_Record().setVisible(true);
            }
        });
    }
